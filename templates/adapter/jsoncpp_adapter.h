...
#ifndef JSON2CPP_JSONCPP_ADAPTER_H
#define JSON2CPP_JSONCPP_ADAPTER_H
...
class JsonCppReader : public IJsonReader {
private:
    const Json::Value* value_;
    bool is_array_context_;

public:
    explicit JsonCppReader(const Json::Value& v);
    explicit JsonCppReader(const Json::Value* v, bool is_array);
...
class JsonCppWriter : public IJsonWriter {
private:
    Json::Value* value_;
    bool is_array_context_;

public:
    explicit JsonCppWriter(Json::Value& v);
    explicit JsonCppWriter(Json::Value* v, bool is_array);
...
#endif // JSON2CPP_JSONCPP_ADAPTER_H
